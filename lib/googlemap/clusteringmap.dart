...
class Clustering extends StatefulWidget {
  @override
  _ClusteringState createState() => _ClusteringState();
}

class _ClusteringState extends State<Clustering> {
  late GoogleMapController mapController;

  Set<Circle> cr = Set.from([
    Circle(
        circleId: CircleId("Delhi"),
        center: LatLng(28.644800, 77.216721),
        radius: 4000,
        fillColor: Colors.red.withOpacity(.3),
        strokeColor: Colors.red.withOpacity(.4),
        strokeWidth: 50),
    Circle(
        circleId: CircleId("noida"),
        center: LatLng(28.535517, 77.391029),
        radius: 4000,
        fillColor: Colors.red.withOpacity(.5),
        strokeColor: Colors.red.withOpacity(.4)),
    Circle(
        circleId: CircleId("Ghaziabad"),
        center: LatLng(28.667856, 77.449791),
        radius: 4000,
        fillColor: Colors.red.withOpacity(.2),
        strokeColor: Colors.red.withOpacity(.4)),
    Circle(
        circleId: CircleId("Faridabad"),
        center: LatLng(28.395403, 77.315292),
        radius: 4000,
        fillColor: Colors.red.withOpacity(.2),
        strokeColor: Colors.red.withOpacity(.3)),
    Circle(
        circleId: CircleId("Gurugram"),
        center: LatLng(28.460596, 77.039597),
        radius: 4000,
        fillColor: Colors.red.withOpacity(.3),
        strokeColor: Colors.red.withOpacity(.3)),
  ]);
              ...
              child: SizedBox(
                ...
                child: GoogleMap(
                  ...
                  initialCameraPosition: CameraPosition(
                      target: LatLng(28.644800, 77.216721), zoom: 10),
